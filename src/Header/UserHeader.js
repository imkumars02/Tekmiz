...
const UserHeader = () => {
  ...
  }, [playlists,fetchedPlaylistIds]);  // Only include fetchedPlaylistIds in the dependency array
      ...
      <header className='Userheader'>
        <section className='flex'>
          ...
          <div className="icons">
            ...
            <div id="notification-btn" onClick={notificationBtn}><IoNotifications /></div>
